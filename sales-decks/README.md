...
The August 2026 ten-slide creator-deck rebuild is preserved as a private, unlisted archive at `/creator-2026-08-archive.html`. Its stylesheet, personalization script, and room-preview image are isolated under matching `creator-2026-08-archive` filenames so the default thirteen-slide creator deck remains byte-for-byte aligned with its pre-rebuild presentation assets.
