const SHELL_REVISION = '0.2.0-sync-window-20260831';
const CACHE = `conductor-pocket-shell-${SHELL_REVISION}`;
const SHELL = [
  '/',
  '/index.html',
  '/app.css?v=0.2.0-sync-window-20260831',
  '/app.js?v=0.2.0-sync-window-20260831',
  '/bootstrap-recovery.js?v=0.2.0-sync-window-20260831',
  '/delivery-receipts.js?v=0.2.0-sync-window-20260831',
  '/draft-conflict.js?v=0.2.0-sync-window-20260831',
  '/usage-state.js?v=0.2.0-sync-window-20260831',
  '/app-update.js?v=0.2.0-sync-window-20260831',
  '/http.js?v=0.2.0-sync-window-20260831',
  '/image-attachments.js?v=0.2.0-sync-window-20260831',
  '/live-refresh.js?v=0.2.0-sync-window-20260831',
  '/read-state.js?v=0.2.0-sync-window-20260831',
  '/rich-text.js?v=0.2.0-sync-window-20260831',
  '/transcript-focus.js?v=0.2.0-sync-window-20260831',
  '/swipe-navigation.js?v=0.2.0-sync-window-20260831',
  '/icon.svg',
