const SHELL_REVISION = '0.2.0-motion-calm-20260828';
const CACHE = `conductor-pocket-shell-${SHELL_REVISION}`;
const SHELL = [
  '/',
  '/index.html',
  '/app.css?v=0.2.0-motion-calm-20260828',
  '/app.js?v=0.2.0-motion-calm-20260828',
  '/bootstrap-recovery.js?v=0.2.0-motion-calm-20260828',
  '/delivery-receipts.js?v=0.2.0-motion-calm-20260828',
  '/draft-conflict.js?v=0.2.0-motion-calm-20260828',
  '/usage-state.js?v=0.2.0-motion-calm-20260828',
  '/app-update.js?v=0.2.0-motion-calm-20260828',
  '/http.js?v=0.2.0-motion-calm-20260828',
  '/image-attachments.js?v=0.2.0-motion-calm-20260828',
  '/live-refresh.js?v=0.2.0-motion-calm-20260828',
  '/read-state.js?v=0.2.0-motion-calm-20260828',
  '/rich-text.js?v=0.2.0-motion-calm-20260828',
  '/transcript-focus.js?v=0.2.0-motion-calm-20260828',
  '/swipe-navigation.js?v=0.2.0-motion-calm-20260828',
  '/icon.svg',
