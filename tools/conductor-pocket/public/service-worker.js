const SHELL_REVISION = '0.2.0-scroll-fix-20260814';
const CACHE = 'conductor-pocket-shell-v24';
const SHELL = [
  '/',
  '/index.html',
  '/app.css?v=0.2.0-scroll-fix-20260814',
  '/app.js?v=0.2.0-scroll-fix-20260814',
  '/bootstrap-recovery.js?v=0.2.0-scroll-fix-20260814',
  '/delivery-receipts.js?v=0.2.0-scroll-fix-20260814',
  '/draft-conflict.js?v=0.2.0-scroll-fix-20260814',
  '/app-update.js?v=0.2.0-scroll-fix-20260814',
  '/http.js?v=0.2.0-scroll-fix-20260814',
  '/image-attachments.js?v=0.2.0-scroll-fix-20260814',
  '/live-refresh.js?v=0.2.0-scroll-fix-20260814',
  '/read-state.js?v=0.2.0-scroll-fix-20260814',
  '/rich-text.js?v=0.2.0-scroll-fix-20260814',
  '/transcript-focus.js?v=0.2.0-scroll-fix-20260814',
  '/swipe-navigation.js?v=0.2.0-scroll-fix-20260814',
  '/icon.svg',
