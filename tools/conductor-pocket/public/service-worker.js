const SHELL_REVISION = '0.2.0-holds-still-20260821';
const CACHE = 'conductor-pocket-shell-v24';
const SHELL = [
  '/',
  '/index.html',
  '/app.css?v=0.2.0-holds-still-20260821',
  '/app.js?v=0.2.0-holds-still-20260821',
  '/bootstrap-recovery.js?v=0.2.0-holds-still-20260821',
  '/delivery-receipts.js?v=0.2.0-holds-still-20260821',
  '/draft-conflict.js?v=0.2.0-holds-still-20260821',
  '/app-update.js?v=0.2.0-holds-still-20260821',
  '/http.js?v=0.2.0-holds-still-20260821',
  '/image-attachments.js?v=0.2.0-holds-still-20260821',
  '/live-refresh.js?v=0.2.0-holds-still-20260821',
  '/read-state.js?v=0.2.0-holds-still-20260821',
  '/rich-text.js?v=0.2.0-holds-still-20260821',
  '/transcript-focus.js?v=0.2.0-holds-still-20260821',
  '/swipe-navigation.js?v=0.2.0-holds-still-20260821',
  '/icon.svg',
