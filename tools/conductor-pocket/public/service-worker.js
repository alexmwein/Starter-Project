const SHELL_REVISION = '0.2.0-retry-recovery-20260830';
const CACHE = `conductor-pocket-shell-${SHELL_REVISION}`;
const SHELL = [
  '/',
  '/index.html',
  '/app.css?v=0.2.0-retry-recovery-20260830',
  '/app.js?v=0.2.0-retry-recovery-20260830',
  '/bootstrap-recovery.js?v=0.2.0-retry-recovery-20260830',
  '/delivery-receipts.js?v=0.2.0-retry-recovery-20260830',
  '/draft-conflict.js?v=0.2.0-retry-recovery-20260830',
  '/usage-state.js?v=0.2.0-retry-recovery-20260830',
  '/app-update.js?v=0.2.0-retry-recovery-20260830',
  '/http.js?v=0.2.0-retry-recovery-20260830',
  '/image-attachments.js?v=0.2.0-retry-recovery-20260830',
  '/live-refresh.js?v=0.2.0-retry-recovery-20260830',
  '/read-state.js?v=0.2.0-retry-recovery-20260830',
  '/rich-text.js?v=0.2.0-retry-recovery-20260830',
  '/transcript-focus.js?v=0.2.0-retry-recovery-20260830',
  '/swipe-navigation.js?v=0.2.0-retry-recovery-20260830',
  '/icon.svg',
