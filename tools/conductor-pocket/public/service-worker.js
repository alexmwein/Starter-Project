const SHELL_REVISION = '0.2.0-chat-strip-stable-20260824';
const CACHE = `conductor-pocket-shell-${SHELL_REVISION}`;
const SHELL = [
  '/',
  '/index.html',
  '/app.css?v=0.2.0-chat-strip-stable-20260824',
  '/app.js?v=0.2.0-chat-strip-stable-20260824',
  '/bootstrap-recovery.js?v=0.2.0-chat-strip-stable-20260824',
  '/delivery-receipts.js?v=0.2.0-chat-strip-stable-20260824',
  '/draft-conflict.js?v=0.2.0-chat-strip-stable-20260824',
  '/usage-state.js?v=0.2.0-chat-strip-stable-20260824',
  '/app-update.js?v=0.2.0-chat-strip-stable-20260824',
  '/http.js?v=0.2.0-chat-strip-stable-20260824',
  '/image-attachments.js?v=0.2.0-chat-strip-stable-20260824',
  '/live-refresh.js?v=0.2.0-chat-strip-stable-20260824',
  '/read-state.js?v=0.2.0-chat-strip-stable-20260824',
  '/rich-text.js?v=0.2.0-chat-strip-stable-20260824',
  '/transcript-focus.js?v=0.2.0-chat-strip-stable-20260824',
  '/swipe-navigation.js?v=0.2.0-chat-strip-stable-20260824',
  '/icon.svg',
