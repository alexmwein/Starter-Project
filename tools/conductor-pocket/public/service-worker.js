const SHELL_REVISION = '0.2.0-tab-control-20260813';
const CACHE = 'conductor-pocket-shell-v24';
const SHELL = [
  '/',
  '/index.html',
  '/app.css?v=0.2.0-tab-control-20260813',
  '/app.js?v=0.2.0-tab-control-20260813',
  '/bootstrap-recovery.js?v=0.2.0-tab-control-20260813',
  '/delivery-receipts.js?v=0.2.0-tab-control-20260813',
  '/draft-conflict.js?v=0.2.0-tab-control-20260813',
  '/app-update.js?v=0.2.0-tab-control-20260813',
  '/http.js?v=0.2.0-tab-control-20260813',
  '/image-attachments.js?v=0.2.0-tab-control-20260813',
  '/live-refresh.js?v=0.2.0-tab-control-20260813',
  '/read-state.js?v=0.2.0-tab-control-20260813',
  '/rich-text.js?v=0.2.0-tab-control-20260813',
  '/transcript-focus.js?v=0.2.0-tab-control-20260813',
  '/swipe-navigation.js?v=0.2.0-tab-control-20260813',
  '/icon.svg',
