const SHELL_REVISION = '0.2.0-no-false-errors-20260820';
const CACHE = 'conductor-pocket-shell-v24';
const SHELL = [
  '/',
  '/index.html',
  '/app.css?v=0.2.0-no-false-errors-20260820',
  '/app.js?v=0.2.0-no-false-errors-20260820',
  '/bootstrap-recovery.js?v=0.2.0-no-false-errors-20260820',
  '/delivery-receipts.js?v=0.2.0-no-false-errors-20260820',
  '/draft-conflict.js?v=0.2.0-no-false-errors-20260820',
  '/app-update.js?v=0.2.0-no-false-errors-20260820',
  '/http.js?v=0.2.0-no-false-errors-20260820',
  '/image-attachments.js?v=0.2.0-no-false-errors-20260820',
  '/live-refresh.js?v=0.2.0-no-false-errors-20260820',
  '/read-state.js?v=0.2.0-no-false-errors-20260820',
  '/rich-text.js?v=0.2.0-no-false-errors-20260820',
  '/transcript-focus.js?v=0.2.0-no-false-errors-20260820',
  '/swipe-navigation.js?v=0.2.0-no-false-errors-20260820',
  '/icon.svg',
