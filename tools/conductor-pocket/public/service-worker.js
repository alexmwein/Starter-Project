const SHELL_REVISION = '0.2.0-storage-unstick-20260901';
const CACHE = `conductor-pocket-shell-${SHELL_REVISION}`;
const SHELL = [
  '/',
  '/index.html',
  '/app.css?v=0.2.0-storage-unstick-20260901',
  '/app.js?v=0.2.0-storage-unstick-20260901',
  '/bootstrap-recovery.js?v=0.2.0-storage-unstick-20260901',
  '/delivery-receipts.js?v=0.2.0-storage-unstick-20260901',
  '/draft-conflict.js?v=0.2.0-storage-unstick-20260901',
  '/usage-state.js?v=0.2.0-storage-unstick-20260901',
  '/app-update.js?v=0.2.0-storage-unstick-20260901',
  '/http.js?v=0.2.0-storage-unstick-20260901',
  '/image-attachments.js?v=0.2.0-storage-unstick-20260901',
  '/live-refresh.js?v=0.2.0-storage-unstick-20260901',
  '/read-state.js?v=0.2.0-storage-unstick-20260901',
  '/rich-text.js?v=0.2.0-storage-unstick-20260901',
  '/transcript-focus.js?v=0.2.0-storage-unstick-20260901',
  '/swipe-navigation.js?v=0.2.0-storage-unstick-20260901',
  '/icon.svg',
