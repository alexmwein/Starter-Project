const SHELL_REVISION = '0.2.0-safe-close-20260815';
const CACHE = 'conductor-pocket-shell-v24';
const SHELL = [
  '/',
  '/index.html',
  '/app.css?v=0.2.0-safe-close-20260815',
  '/app.js?v=0.2.0-safe-close-20260815',
  '/bootstrap-recovery.js?v=0.2.0-safe-close-20260815',
  '/delivery-receipts.js?v=0.2.0-safe-close-20260815',
  '/draft-conflict.js?v=0.2.0-safe-close-20260815',
  '/app-update.js?v=0.2.0-safe-close-20260815',
  '/http.js?v=0.2.0-safe-close-20260815',
  '/image-attachments.js?v=0.2.0-safe-close-20260815',
  '/live-refresh.js?v=0.2.0-safe-close-20260815',
  '/read-state.js?v=0.2.0-safe-close-20260815',
  '/rich-text.js?v=0.2.0-safe-close-20260815',
  '/transcript-focus.js?v=0.2.0-safe-close-20260815',
  '/swipe-navigation.js?v=0.2.0-safe-close-20260815',
  '/icon.svg',
