const SHELL_REVISION = '0.2.0-usage-send-readiness-20260827';
const CACHE = `conductor-pocket-shell-${SHELL_REVISION}`;
const SHELL = [
  '/',
  '/index.html',
  '/app.css?v=0.2.0-usage-send-readiness-20260827',
  '/app.js?v=0.2.0-usage-send-readiness-20260827',
  '/bootstrap-recovery.js?v=0.2.0-usage-send-readiness-20260827',
  '/delivery-receipts.js?v=0.2.0-usage-send-readiness-20260827',
  '/draft-conflict.js?v=0.2.0-usage-send-readiness-20260827',
  '/usage-state.js?v=0.2.0-usage-send-readiness-20260827',
  '/app-update.js?v=0.2.0-usage-send-readiness-20260827',
  '/http.js?v=0.2.0-usage-send-readiness-20260827',
  '/image-attachments.js?v=0.2.0-usage-send-readiness-20260827',
  '/live-refresh.js?v=0.2.0-usage-send-readiness-20260827',
  '/read-state.js?v=0.2.0-usage-send-readiness-20260827',
  '/rich-text.js?v=0.2.0-usage-send-readiness-20260827',
  '/transcript-focus.js?v=0.2.0-usage-send-readiness-20260827',
  '/swipe-navigation.js?v=0.2.0-usage-send-readiness-20260827',
  '/icon.svg',
