...
export const SHELL_REVISION = '0.2.0-pocket-storage-selfheal-20260830';
...
export const RECOVERY_COOKIE = '__Host-cp_recovery';
...
export const TRUST_RENEWAL_WINDOW_MS = 5 * 24 * 60 * 60 * 1000;
